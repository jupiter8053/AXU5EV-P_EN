...
set_property PACKAGE_PIN F10   [get_ports {edid_scl[0]}]
set_property PACKAGE_PIN G11   [get_ports {edid_sda[0]}]
set_property PACKAGE_PIN E8   [get_ports {hpd[0]}]

set_property IOSTANDARD LVCMOS33 [get_ports {edid_scl[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {edid_sda[0]}]
